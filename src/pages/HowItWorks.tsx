...
export function HowItWorks() {
  return (
    <MarketingShell
      ...
      intro="NameDay isn’t a filing service and doesn’t pretend to be. It’s the thing that turns a month of research into an afternoon of tasks."
    >
      <div className="space-y-14">
        {/* ------------------------------------------------------ The order */}
        <section>
          <h2 className="text-2xl text-ink-900">The order of operations</h2>
          <p className="mt-2 leading-relaxed text-ink-600">
            This is the part that trips everyone up. Each step below unlocks the ones after it,
            and NameDay locks a task until its dependency is done so you never make a wasted trip.
          </p>
              ...
              return (
                <li key={phase.n}>
                  <Card className="flex gap-4 p-5">
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-rose-600 font-display text-white">
                      {phase.n}
                    </span>
                    <div className="min-w-0">
                      <p className="font-medium text-ink-900">{phase.title}</p>
                      <p className="mt-1 text-sm leading-relaxed text-ink-600">{phase.caption}</p>
          ...
          <Callout tone="amber" icon={<Lock size={16} />} className="mt-5">
        ...
        {/* --------------------------------------------------- What we cover */}
        <section>
          <h2 className="text-2xl text-ink-900">What we track</h2>
          <p className="mt-2 leading-relaxed text-ink-600">
            ...
            {CATEGORIES.map((category) => {
              ...
              return (
                <Card key={category.id} className="p-5">
                  ...
                  <p className="mt-1 text-sm text-ink-500">{category.blurb}</p>
                  <ul className="mt-3 space-y-1 text-sm text-ink-600">
                    ...
                    {items.length > 4 && (
                      <li className="pl-5 text-ink-400">+ {items.length - 4} more</li>
                    )}
                  </ul>
                </Card>
              );
        ...
        {/* ------------------------------------------------- What we can't do */}
        <section>
          <h2 className="text-2xl text-ink-900">What NameDay can and can’t do</h2>
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            ...
            <Card className="p-5">
              <p className="font-medium text-ink-900">You submit</p>
              <ul className="mt-3 space-y-2 text-sm text-ink-700">
                {[
              ...
              <p className="mt-4 text-sm leading-relaxed text-ink-500">
                ...
                change on your behalf, and we won’t claim otherwise. Every link in NameDay goes
        ...
        {/* -------------------------------------------------------- States */}
        <section>
          <h2 className="text-2xl text-ink-900">State-specific guidance</h2>
          <p className="mt-2 leading-relaxed text-ink-600">
        ...
        {/* ----------------------------------------------------------- CTA */}
        <section className="rounded-[1.75rem] bg-ink-900 px-7 py-12 text-center sm:px-12">
          <h2 className="font-display text-3xl text-paper">Ready when you are</h2>
